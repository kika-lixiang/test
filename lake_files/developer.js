 ...
 */
 ...
 // window._bd_share_config={common:{bdText:"我在玩《无尽的河流》，你敢来挑战我吗？",bdDesc:"我爱h5游戏源码，游戏AND源码，一个也不能少~",bdUrl:"http://www.52h5game.com/game/wujindeheliu/",bdPic:"http://www.52h5game.com/images/logo.png"},share:[{"bdSize":16}],slide:[{bdImg:0,bdPos:"right",bdTop:100}]};with(document){0[(getElementsByTagName("head")[0]||body).appendChild(createElement("script")).src="http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion="+~(-new Date()/3600000)]};
