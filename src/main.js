...
(function() {
  ...
  e.action = {}, e.action.Role = function(e, t, r, i, s, o, u, a) { this.imageNames = s || [], this.rects = o || [], this.frames = u || [], this.actions = a || [], this.sprites = n(e, this.imageNames, this.rects, this.frames, this.actions) || [], this.x = t || 0, this.y = r || 0, this.dx = 0, this.dy = 0, this.step = 0, this.id = "", this.mapOffx = this.x, this.mapOffy = this.y, this.svx = null, this.svy = null, this.current = i || 0, this._cr = this.current, this.zoom = 1, this.angle = 0, this._zooms = [], this._angles = [], this._moveDs = [4, 7, 5, 5, 6, -5, -5, -7], this._stopDs = [0, -3, 1, 1, 2, -1, -1, -3], this.dsIndex = 4, this._path = []; var f = this.getSprite(),
    ...
    i = [{ loop: !0, frames: [
        ...
        [2, 0, 0, 0],
        [1, 0, 0, 0]
      ] }]; return { get: function(s, o) { var u = s >= 0 && i[s] ? [i[s]] : i; return new e.action.role([], 0, 0, 0, o ? o : t, n, r, u || i) } } }), define("shine", ["lib/link"], function(e) { e.asyncImage([{ id: "shine", src: "http://www.tcyclops.com/both-survive/wu.png" }]); var t = ["shine"],
    n = [
      [
        [0, 20, 101, 64],
        [119, 19, 112, 66],
  ...
  require(["lib/link", "index"], 
    function(e, t) { 
      e.init(window.innerWidth, window.innerHeight).pushImage([
        { id: "logo", src: "http://www.tcyclops.com/both-survive/ygdbns.jpg" }, 
        { id: "btns1", src: "http://www.tcyclops.com/both-survive/gdyx.png" }], 
        function(e, t, n) {}).initAudio([
        { id: "1", src: "sound/1.mp3", preload: !0 }
        ]).loadingCallBack(
        function(e, t) {}).main(function() { t.init() }) }), define("main", function() {});